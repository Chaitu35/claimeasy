...
func (e UserEdges) PermissionsOrErr() ([]*Permissions, error) {
	if e.loadedTypes[0] {
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldName, user.FieldUsername, user.FieldPasswordHash, user.FieldEmail, user.FieldMobile, user.FieldRole, user.FieldStatus, user.FieldNationalID, user.FieldCountry:
