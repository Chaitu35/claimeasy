...
func (pq *PermissionsQuery) QueryUser() *UserQuery {
...
func (pq *PermissionsQuery) WithUser(opts ...func(*UserQuery)) *PermissionsQuery {
	query := (&UserClient{config: pq.config}).Query()
...
//		GroupBy(permissions.FieldModule).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Permissions.Query().
//		Select(permissions.FieldModule).
//		Scan(ctx, &v)
...
func (pq *PermissionsQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Permissions, error) {
	...
	if withFKs {
		_spec.Node.Columns = append(_spec.Node.Columns, permissions.ForeignKeys...)
	}
	...
	if query := pq.withUser; query != nil {
		if err := pq.loadUser(ctx, query, nodes, nil,
			func(n *Permissions, e *User) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (pq *PermissionsQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Permissions, init func(*Permissions), assign func(*Permissions, *User)) error {
