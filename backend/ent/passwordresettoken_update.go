...
func (prtu *PasswordResetTokenUpdate) SetCreatedAt(t time.Time) *PasswordResetTokenUpdate {
	prtu.mutation.SetCreatedAt(t)
	return prtu
}

// SetNillableCreatedAt sets the "created_at" field if the given value is not nil.
func (prtu *PasswordResetTokenUpdate) SetNillableCreatedAt(t *time.Time) *PasswordResetTokenUpdate {
	if t != nil {
		prtu.SetCreatedAt(*t)
	}
	return prtu
...
func (prtu *PasswordResetTokenUpdate) AddUserIDs(ids ...int) *PasswordResetTokenUpdate {
	prtu.mutation.AddUserIDs(ids...)
	return prtu
}

// AddUser adds the "user" edges to the User entity.
func (prtu *PasswordResetTokenUpdate) AddUser(u ...*User) *PasswordResetTokenUpdate {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return prtu.AddUserIDs(ids...)
}
...
func (prtu *PasswordResetTokenUpdate) RemoveUserIDs(ids ...int) *PasswordResetTokenUpdate {
	prtu.mutation.RemoveUserIDs(ids...)
	return prtu
}

// RemoveUser removes "user" edges to User entities.
func (prtu *PasswordResetTokenUpdate) RemoveUser(u ...*User) *PasswordResetTokenUpdate {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return prtu.RemoveUserIDs(ids...)
}
...
func (prtu *PasswordResetTokenUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := prtu.mutation.CreatedAt(); ok {
	...
	if prtu.mutation.UserCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: passwordresettoken.UserPrimaryKey,
			Bidi:    false,
	...
	if nodes := prtu.mutation.RemovedUserIDs(); len(nodes) > 0 && !prtu.mutation.UserCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   passwordresettoken.UserTable,
...
// SetCreatedAt sets the "created_at" field.
func (prtuo *PasswordResetTokenUpdateOne) SetCreatedAt(t time.Time) *PasswordResetTokenUpdateOne {
	prtuo.mutation.SetCreatedAt(t)
	return prtuo
}

// SetNillableCreatedAt sets the "created_at" field if the given value is not nil.
func (prtuo *PasswordResetTokenUpdateOne) SetNillableCreatedAt(t *time.Time) *PasswordResetTokenUpdateOne {
	if t != nil {
		prtuo.SetCreatedAt(*t)
	}
	return prtuo
}

// AddUserIDs adds the "user" edge to the User entity by IDs.
func (prtuo *PasswordResetTokenUpdateOne) AddUserIDs(ids ...int) *PasswordResetTokenUpdateOne {
	prtuo.mutation.AddUserIDs(ids...)
	return prtuo
}

// AddUser adds the "user" edges to the User entity.
func (prtuo *PasswordResetTokenUpdateOne) AddUser(u ...*User) *PasswordResetTokenUpdateOne {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return prtuo.AddUserIDs(ids...)
}
...
// RemoveUserIDs removes the "user" edge to User entities by IDs.
func (prtuo *PasswordResetTokenUpdateOne) RemoveUserIDs(ids ...int) *PasswordResetTokenUpdateOne {
	prtuo.mutation.RemoveUserIDs(ids...)
	return prtuo
}

// RemoveUser removes "user" edges to User entities.
func (prtuo *PasswordResetTokenUpdateOne) RemoveUser(u ...*User) *PasswordResetTokenUpdateOne {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return prtuo.RemoveUserIDs(ids...)
}
...
func (prtuo *PasswordResetTokenUpdateOne) sqlSave(ctx context.Context) (_node *PasswordResetToken, err error) {
	...
	if value, ok := prtuo.mutation.CreatedAt(); ok {
		_spec.SetField(passwordresettoken.FieldCreatedAt, field.TypeTime, value)
	}
	...
	if nodes := prtuo.mutation.RemovedUserIDs(); len(nodes) > 0 && !prtuo.mutation.UserCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   passwordresettoken.UserTable,
