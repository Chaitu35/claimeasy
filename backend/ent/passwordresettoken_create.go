...
func (prtc *PasswordResetTokenCreate) AddUserIDs(ids ...int) *PasswordResetTokenCreate {
	prtc.mutation.AddUserIDs(ids...)
	return prtc
}

// AddUser adds the "user" edges to the User entity.
func (prtc *PasswordResetTokenCreate) AddUser(u ...*User) *PasswordResetTokenCreate {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return prtc.AddUserIDs(ids...)
}
